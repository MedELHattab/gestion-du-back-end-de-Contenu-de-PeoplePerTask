...
<body>
                        ...
                        if(!$result) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-success acceptOfferBtn"
                                            data-offer-id="<?php echo $row['Offer_ID']; ?>">Accept</button></td>
                                    <td> <button class="btn btn-danger refuseOfferBtn"
                                            data-offer-id="<?php echo $row['Offer_ID']; ?>">Refuse</button></td>
    ...
    <script>
        $(document).ready(function () {
            $(".acceptOfferBtn").click(function (e) {
                e.preventDefault();
                var offerId = $(this).data("offer-id");
                handleOfferAction(offerId, "accepted");
            });

            $(".refuseOfferBtn").click(function (e) {
                e.preventDefault();
                var offerId = $(this).data("offer-id");
                handleOfferAction(offerId, "refused");
            });
